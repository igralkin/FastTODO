...
def test_get_task():
    ...
    datetime_to_do = datetime.fromisoformat(data["datetime_to_do"].replace("Z", "+00:00"))
...
def test_update_task_unauthorized():
    ...
    response = client.patch(
        f"/tasks/{task_id}/update",
        json={"datetime_to_do": "2025-01-01T10:00:00", "task_info": "Unauthorized update"}
    )
